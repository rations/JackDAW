/* ladspa.h
   ...
   This header is in the public domain (LADSPA, 2000, Richard W.E. Furse,
   Paul Barton-Davis, Stefan Westerfeld). Trimmed to the subset JackDAW's
   host needs; ABI-compatible with the canonical header. */
